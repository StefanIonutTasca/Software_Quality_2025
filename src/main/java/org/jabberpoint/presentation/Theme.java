...
/**
 * Theme class represents styling options for a presentation. This class is deliberately not
 * formatted according to Google Java Format to demonstrate the automatic formatting workflow.
 */
public class Theme {
  private String name;
  ...
  public Theme(String name, Color backgroundColor, Color textColor, Font titleFont, Font bodyFont) {
    this.name = name;
  ...
  public static Theme createCustomTheme(
      Color backgroundColor, Color textColor, String fontName, int fontSize) {
