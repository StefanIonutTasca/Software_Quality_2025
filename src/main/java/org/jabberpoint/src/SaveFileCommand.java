...
public class SaveFileCommand implements Command {
  ...
  /**
   * Executes the command to save a file In headless environments (without GUI) or when parent is
   * null, this is a no-op as file chooser dialog cannot be shown
   */
  @Override
  public void execute() {
