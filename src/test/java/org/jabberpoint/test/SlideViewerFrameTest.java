...
class SlideViewerFrameTest {
  ...
  @Mock private SlideViewerComponent mockSlideViewerComponent;
  ...
  void constructorShouldSetupWindowWithExpectedProperties() {
    ...
    try {
      ...
      // Assert
      assertEquals(
          "Jabberpoint 1.6 - OU", frame.getTitle(), "Title should be set to JABTITLE constant");
      assertEquals(
          new Dimension(
              org.jabberpoint.src.ui.SlideViewerFrame.WIDTH,
              org.jabberpoint.src.ui.SlideViewerFrame.HEIGHT),
          frame.getSize(),
      ...
      assertTrue(
          frame.getKeyListeners()[0] instanceof KeyController,
      ...
      assertTrue(
          frame.getMenuBar() instanceof MenuController,
  ...
  void slideViewerFrameShouldCreateSlideViewerComponentDuringInitialization() {
    ...
    try {
      ...
      assertTrue(
          contentPane.getComponent(0) instanceof SlideViewerComponent,
  ...
  void slideViewerFrameShouldHandleAllWindowEventsBesidesWindowClosing() {
    ...
    try {
      ...
      assertDoesNotThrow(
          () -> windowListener.windowActivated(activatedEvent),
          "windowActivated should not throw exception");
      assertDoesNotThrow(
          () -> windowListener.windowDeactivated(deactivatedEvent),
          "windowDeactivated should not throw exception");
      assertDoesNotThrow(
          () -> windowListener.windowIconified(iconifiedEvent),
          "windowIconified should not throw exception");
      assertDoesNotThrow(
          () -> windowListener.windowDeiconified(deiconifiedEvent),
          "windowDeiconified should not throw exception");
      assertDoesNotThrow(
          () -> windowListener.windowOpened(openedEvent),
          "windowOpened should not throw exception");
      assertDoesNotThrow(
          () -> windowListener.windowClosed(closedEvent),
