...
class DemoPresentationLoaderTest {
  ...
  void loadPresentationShouldCreateDemoPresentation() throws IOException {
    ...
    assertEquals(
        ...
        "Presentation title should be 'Demo Presentation'");
  ...
  void loadPresentationShouldCreateThirdSlideCorrectly() throws IOException {
    ...
    assertEquals(
        "The third slide", thirdSlide.getTitle(), "Third slide title should be 'The third slide'");
  ...
  void loadPresentationShouldHandleAnySourceParameterWithoutErrors() {
    ...
    for (String source : sources) {
      assertDoesNotThrow(
          () -> loader.loadPresentation(new Presentation(), source),
  ...
  void loadPresentationShouldCreateConsistentDemoPresentation() throws IOException {
    ...
    assertEquals(
        presentation1.getSize(), presentation2.getSize(), "Number of slides should be identical");
    ...
    for (int i = 0; i < presentation1.getSize(); i++) {
      ...
      assertEquals(
          slide1.getTitle(), slide2.getTitle(), "Slide " + i + " titles should be identical");
      assertEquals(
          slide1.getSize(), slide2.getSize(), "Slide " + i + " should have same number of items");
    }
  }
}
