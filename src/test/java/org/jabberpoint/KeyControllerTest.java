...
import org.jabberpoint.KeyController;
import org.jabberpoint.Presentation;
import org.jabberpoint.SlideViewerComponent;
...
class KeyControllerTest {
    ...
    void shouldMoveToNextSlideOnPageDown() {
        // Arrange
        KeyEvent keyEvent = new KeyEvent(new DummyComponent(), KeyEvent.KEY_PRESSED, 
    ...
    void shouldMoveToNextSlideOnPlus() {
        // Arrange
        KeyEvent keyEvent = new KeyEvent(new DummyComponent(), KeyEvent.KEY_PRESSED, 
                System.currentTimeMillis(), 0, (int)'+', '+');
    ...
    void shouldExitOnLowercaseQ() {
        // Arrange
        KeyEvent keyEvent = new KeyEvent(new DummyComponent(), KeyEvent.KEY_PRESSED, 
                System.currentTimeMillis(), 0, (int)'q', 'q');
